...
static struct config_int ConfigureNamesInt[] =
{
	...
	/* cs3223 */
	{
		{"bitvector_size", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Sets the size of bit vector for optimizing hash join."),
			gettext_noop("Sets the size of bit vector for optimizing hash join."),
			GUC_UNIT_KB
		},
		&bitvector_size,
	...
	/* cs3223 */
	{
		{"hash_method", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Sets the hash method for bit vector optimization."), 
			gettext_noop("Sets the hash method for bit vector optimization.")
		},
		&hash_method,
		1, 1, MAX_NUM_HASH_METHODS,
		NULL, NULL, NULL
	},
